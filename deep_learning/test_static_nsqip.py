...
file_out = f"/home/luojiawei/pengxiran_project/结果文件夹/模型性能/{y_name}_{stage}_nsqip.csv"

# -------  模型参数 -----------
# lab_pre/post 36 + 36, vit_pre 79 + 78, vit_in 71 * 2, vit_post 79 + 78, x_s 48, oper 4
input_size_list = [36 + 36 + 48, 79 + 78, 71 * 2]#, 71 * 2, 79 + 78, 36 + 36 + 4
hidden_size_list = [256, 256, 256] #, 256, 256, 256
output_size_list = [1]
type_list = ["cat"]
model_list = ["mlp","biattlstm", "biattlstm"]#, "biattlstm","biattlstm","mlp"

print(f"task: {y_name}, stage: {stage}")

dataset_te = INSPIRE("/home/luojiawei/pengxiran_project_data/all_op_id1/",
                    "/home/luojiawei/pengxiran_project_data/ds_id_nsqip.csv",
                    id_col="op_id",
                    mod_col=None,
                    mod = None,
                    cls_col = None,
